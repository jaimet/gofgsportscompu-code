...
exporter.tcx = {
    ...
    _waypoint : function( p_waypoint ) {
                    if( exporter.tcx.m_trackStartTime == 0 ) {
                        exporter.tcx.m_trackStartTime = p_waypoint.m_timestamp;
                        ...
                        $(lNode).text( Utilities.toDegree( p_waypoint.m_position.coords.latitude ) );
                        bpNode.appendChild( lNode );
                        lNode = exporter.tcx.m_xmlDoc.createElement( 'LongitudeDegrees' );
                        $(lNode).text( Utilities.toDegree( p_waypoint.m_position.coords.longitude ) );
                        bpNode.appendChild( lNode );
                    ...
                    exporter.tcx.m_trackTotalDistance += p_waypoint.m_distance;
                    ...
                    $(aNode).text( p_waypoint.m_position.coords.altitude );
                    ...
                    $(vNode).text( p_waypoint.m_heartrate );
                    ...
                    // Save last waypoint
                    exporter.tcx.m_lastWaypoint = p_waypoint;
                },
    ...
    _trackComplete : function( p_track ) {
                         ...
                         if( exporter.tcx.m_lastWaypoint != null ) {
                             ...
                             $(ttNode).text( exporter.tcx.m_lastWaypoint.m_timestamp - exporter.tcx.m_trackStartTime );
                             ...
                             var lNode = exporter.tcx.m_xmlDoc.createElement( 'LatitudeDegrees' );
                             $(lNode).text( Utilities.toDegree( exporter.tcx.m_lastWaypoint.m_position.coords.latitude ) );
                             epNode.appendChild( lNode );
                             lNode = exporter.tcx.m_xmlDoc.createElement( 'LongitudeDegrees' );
                             $(lNode).text( Utilities.toDegree( exporter.tcx.m_lastWaypoint.m_position.coords.longitude ) );
                             epNode.appendChild( lNode );
    ...
    _toString : function() {
                    ...
                    try {
                        ...
                        xmlString = (new XMLSerializer()).serializeToString(exporter.tcx.m_xmlDoc);
                    }
                    catch (e) {
                        try {
                            // Internet Explorer.
                            xmlString = exporter.tcx.m_xmlDoc.xml;
                        }
                        catch (e) {
